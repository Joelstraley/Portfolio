       ...
       <Container style={{ marginTop: 100 }}>
          ...
          <Row>
              ...
              <Col size="md-9" id="about">
                    ...
                    <i className="far fa-envelope fa-2x"></i></a>
                    <a href="tel:937-206-4970"> 
                    <i className="fas fa-phone-square fa-2x"></i></a>
                    <div className="new-line"></div>
                    <a href="./assets/JOEL STRALEY RESUME - 2021 - WEB DEV (1).pdf" download>Download PDF Resume</a>
                  </div>
              </Col>
          </Row>
      </Container> 
