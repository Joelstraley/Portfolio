...
function Toolbox(props) { 
  ...
  return (
      ...
      <div className="title mx-auto personalLinks">
        <h1 className="title" id="toolbox">Tools&ensp;🧰 </h1>
        <div >
        ...
        <img src="https://images.g2crowd.com/uploads/product/image/large_detail/large_detail_f0b606abb6d19089febc9faeeba5bc05/nodejs-development-services.png" alt="NodeJS logo" width="50" height="50" />
        <img src="https://pngimage.net/wp-content/uploads/2018/05/express-js-png-5.png" alt="Express logo" width="50" height="50" />        
